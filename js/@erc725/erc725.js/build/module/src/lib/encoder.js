...
import { hexToNumber, hexToUtf8, isAddress, isHex, keccak256, numberToHex, padLeft, toChecksumAddress, utf8ToHex, } from 'web3-utils';
...
const encodeDataSourceWithHash = (hashType, dataHash, dataSource) => {
    ...
    return (keccak256(hashFunction.name).slice(0, 10) +
        dataHash.slice(2) +
            ...
            return {
                ...
                encode: (dataToEncode) => {
                    ...
                    return encodeDataSourceWithHash(hashFunction ||
                        SUPPORTED_HASH_FUNCTION_STRINGS.KECCAK256_UTF8, hashedJson, url);
                },
