 ...
 * @date 2020
 */
import { checkAddressChecksum, isAddress, numberToHex, padLeft, } from 'web3-utils';
...
export function getHashFunction(hashFunctionNameOrHash) {
    ...
    if (!hashFunction) {
        throw new Error(`Chosen hashFunction '${hashFunctionNameOrHash}' is not supported. Supported hashFunctions: ${SUPPORTED_HASH_FUNCTIONS_LIST}`);
    }
    return hashFunction;
}
