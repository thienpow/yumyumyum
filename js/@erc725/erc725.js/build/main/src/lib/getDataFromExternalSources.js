...
const getDataFromExternalSources = (schemas, dataFromChain, ipfsGateway) => {
    const promises = dataFromChain.map(async (dataEntry) => {
        ...
        return (0, utils_1.isDataAuthentic)(receivedData, urlDataWithHash.hash, urlDataWithHash.hashFunction)
